...
SHM_KEYS_BEFORE_FILE=`mktemp /tmp/shmkeys_before.XXXXXXXXXX`
SEM_KEYS_BEFORE_FILE=`mktemp /tmp/semkeys_before.XXXXXXXXXX`
SHM_KEYS_AFTER_FILE=`mktemp /tmp/shmkeys_after.XXXXXXXXXX`
SEM_KEYS_AFTER_FILE=`mktemp /tmp/semkeys_after.XXXXXXXXXX`
...
SMALL_BINARY_FILE_RESULT=`mktemp /tmp/small_binary_file_result.bin.XXXXXXXXXX`
SMALL_TEXT_FILE_RESULT=`mktemp /tmp/small_text_file_result.txt.XXXXXXXXXX`
HUGE_BINARY_FILE_RESULT=`mktemp /tmp/huge_binary_file_result.bin.XXXXXXXXXX`
